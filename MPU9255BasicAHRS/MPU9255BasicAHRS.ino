/* MPU9255 Basic Example Code
 ...
 Note: The MPU9255 is an I2C sensor and uses the Arduino Wire library. 
 ...
 * <comment data>/n
 */
void send2pccomment();// send commment to pc
/*!
 * send2pcdata()
 * [ax;ay;az;gx;gy;gz;mx;my;mz;Yaw;Pitch;Roll;/n
 * [data1;data2;data3;...;dataend]/n
 */
void send2pcdata(); // send data to pc
...
float vx, vy, vz;
float vx_0 = 0.0f, vy_0  = 0.0f, vz_0  = 0.0f;
...
void setup()
{
  ...
  byte c = readByte(MPU9255_ADDRESS, WHO_AM_I_MPU9255);  // Read WHO_AM_I register for MPU-9255
  Serial.print("<");
  Serial.print("MPU9255 ");  Serial.print("I AM "); Serial.print(c, HEX); Serial.print(" I should be "); Serial.print(0x73, HEX);
  Serial.println(">");
  if (c == 0x73) // WHO_AM_I should always be 0x68
  {  
    Serial.print("<");Serial.print("MPU9255 is online...");Serial.println(">");    
    MPU9255SelfTest(SelfTest); // Start by performing self test and reporting values
    Serial.print("<");
    Serial.print("x-axis self test: acceleration trim within : "); Serial.print(SelfTest[0],1); Serial.print("% of factory value");
    Serial.println(">");
    
    Serial.print("<");
    Serial.print("y-axis self test: acceleration trim within : "); Serial.print(SelfTest[1],1); Serial.print("% of factory value");
    Serial.println(">");
    
    Serial.print("<");
    Serial.print("z-axis self test: acceleration trim within : "); Serial.print(SelfTest[2],1); Serial.print("% of factory value");
    Serial.println(">");
    
    Serial.print("<");
    Serial.print("x-axis self test: gyration trim within : "); Serial.print(SelfTest[3],1); Serial.print("% of factory value");
    Serial.println(">");
    
    Serial.print("<");
    Serial.print("y-axis self test: gyration trim within : "); Serial.print(SelfTest[4],1); Serial.print("% of factory value");
    Serial.println(">");
    
    Serial.print("<");
    Serial.print("z-axis self test: gyration trim within : "); Serial.print(SelfTest[5],1); Serial.print("% of factory value");
    Serial.println(">");
    ...
    Serial.print("<");
    Serial.print("MPU9255 initialized for active data mode...."); // Initialize device for active mode read of acclerometer, gyroscope, and temperature
    Serial.println(">");
    
    // Read the WHO_AM_I register of the magnetometer, this is a good test of communication
    byte d = readByte(AK8963_ADDRESS, AK8963_WHO_AM_I);  // Read WHO_AM_I register for AK8963
    Serial.print("<");
    Serial.print("AK8963 "); Serial.print("I AM "); Serial.print(d, HEX); Serial.print(" I should be "); Serial.print(0x48, HEX);
    Serial.println(">");
 
    // Get magnetometer calibration from AK8963 ROM
    initAK8963(magCalibration);
    Serial.print("<"); 
    Serial.print("AK8963 initialized for active data mode...."); // Initialize device for active mode read of magnetometer
    Serial.println(">");
  
  if(SerialDebug) {
    //  Serial.println("Calibration values: ");
    Serial.print("<"); 
    Serial.print("X-Axis sensitivity adjustment value "); Serial.print(magCalibration[0], 2);
    Serial.println(">");

    Serial.print("<"); 
    Serial.print("Y-Axis sensitivity adjustment value "); Serial.print(magCalibration[1], 2);
    Serial.println(">");

    Serial.print("<"); 
    Serial.print("Z-Axis sensitivity adjustment value "); Serial.print(magCalibration[2], 2);
    Serial.println(">");
  }  
  ...
  {
    Serial.print("<"); 
    Serial.print("Could not connect to MPU9255: 0x");
    Serial.println(">");
...
{  
  ...
  if (readByte(MPU9255_ADDRESS, INT_STATUS) & 0x01) 
    ...
    if (!AHRS) {
      ...
      if(delt_t > 500) {  
        if(SerialDebug) {
          ...
          Serial.print("<"); 
          Serial.print("Z-gyro rate: "); Serial.print(gz, 3); Serial.print(" degrees/sec"); 
          Serial.println(">");
          
          // Print mag values in degree/sec
          Serial.print("<"); 
          Serial.print("X-mag field: "); Serial.print(mx); Serial.print(" G "); 
          Serial.println(">");

          Serial.print("<"); 
          Serial.print("Y-mag field: "); Serial.print(my); Serial.print(" G "); 
          Serial.println(">");

          Serial.print("<"); 
          Serial.print("Z-mag field: "); Serial.print(mz); Serial.print(" G"); 
          Serial.println(">");
         ...
         // Print temperature in degrees Centigrade  
          Serial.print("<");     
          Serial.print("Temperature is ");  Serial.print(temperature, 1);  Serial.print(" degrees C"); // Print T values to tenths of s degree C
          Serial.println(">");
        }
        count = millis();
      ...
      // Serial print and/or display at 0.01 s rate independent of data rates
      delt_t = millis() - count;
      if (delt_t > 10) 
      { 
...
//         roll  *= 180.0f / PI;
         ...
         vx = vx_0 + ax*delt_t/1000.0*9.81;
         vy = vy_0 + ay*delt_t/1000.0*9.81;
         vz = vz_0 + az*delt_t/1000.0*9.81;
         vx_0 = vx;
         vy_0 = vy;
         vz_0 = vz;
        ...
        if(SerialDebug) 
        {
          //
          Serial.print("[");
          Serial.print(ax, 3);Serial.print(";");// accelerate unit is g
          ...
          Serial.print(vz, 3);Serial.println(";");
        }
        /*!        
...
{  
 ...
 // Set sample rate = gyroscope output rate/(1 + SMPLRT_DIV)
  writeByte(MPU9255_ADDRESS, SMPLRT_DIV, 0x04);  // Use a 200 Hz rate; a rate consistent with the filter update rate 
...
void MPU9255SelfTest(float * destination) // Should return percent deviation from factory trim values, +/- 14 or less deviation is a pass
{
  ...
  writeByte(MPU9255_ADDRESS, GYRO_CONFIG, FS<<3);  // Set full scale range for the gyro to 250 dps
  writeByte(MPU9255_ADDRESS, ACCEL_CONFIG2, 0x02); // Set accelerometer rate to 1 kHz and bandwidth to 92 Hz
  writeByte(MPU9255_ADDRESS, ACCEL_CONFIG, FS<<3); // Set full scale range for the accelerometer to 2 g
